...
(function () {
    ...
    function commandsRequested(eventArgs) {
        ...
        var privacyCommand = new Windows.UI.ApplicationSettings.SettingsCommand('privacy', 'Privacy Policy', function () {
            window.open('http://martins-web.com/starmanager/privacystatement.html');
        });
    ...
    app.start();
    // Only allow landscape so that app doesn't rotate on portrait orientation
    // It doesn't seem to work in simulator, need to test on real tablet
    Windows.Graphics.Display.DisplayProperties.autoRotationPreferences = 5;
})();
